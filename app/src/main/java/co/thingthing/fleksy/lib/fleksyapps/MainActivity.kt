...
import co.thingthing.fleksy.lib.fleksyapps.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.imeCurrent.setOnClickListener { showInputMethodPicker() }
        binding.tryEditText.setOnEditorActionListener { v, _, _ -> v.text = ""; true }
    }
